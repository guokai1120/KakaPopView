...
@interface KakaPopView ()<UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, assign) KKDirectionType type;

@property (nonatomic, strong) UITableView *tableView;
@end

@implementation KakaPopView

- (instancetype)initWithOrigin:(CGPoint)origin Width:(CGFloat)width Height:(CGFloat)height Type:(KKDirectionType)type Color:(UIColor *)color
{
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.type) {
        case KKTypeOfUpLeft:
        case KKTypeOfUpCenter:
        case KKTypeOfUpRight:{
            {
        ...
        case KKTypeOfDownLeft:
        case KKTypeOfDownCenter:
        case KKTypeOfDownRight: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
        ...
        case KKTypeOfLeftUp:
        case KKTypeOfLeftCenter:
        case KKTypeOfLeftDown: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
        ...
        case KKTypeOfRightUp:
        case KKTypeOfRightCenter:
        case KKTypeOfRightDown: {
            {
                CGFloat startX = self.origin.x;
                CGFloat startY = self.origin.y;
                CGContextMoveToPoint(context, startX, startY);
